...
class Hielocos extends Phaser.Scene
{
    ...
    create()
    {
        ...
        const spritePinguino = this.add.sprite(arrayCarril[1], 900, 'pinguino').setScale(2);
        ...
        this.physics.add.collider(spritePinguino, grupoHielos, function(pinguino, hielito) {
            if(pinguino.body.touching && hielito.body.touching){
                //chocas
